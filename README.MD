...
ESP32 UART2 ←→ Serial Transceiver (RS-422 here)  ←→ Pi Zero UART
   ...
   PPP Client            Up to 1200m             PPP Server & Router 
    10.0.5.2                                     10.0.5.1 / e.g 192.X.Y.Z    
...
For more UART examples, see https://github.com/jouellnyc/UART.
...
See [wpa-ent-mschapv2-bridge](https://github.com/jouellnyc/wpa-ent-mschapv2-bridge) and [UART ESP32 Pi Zero PPP](https://github.com/jouellnyc/UART/tree/main/esp32_pizero_ppp)
...
- 🐍 The ideas, configs, connections, testing, etc are mine. But Clause and I partnered on this repo and the README!
...
4. Ensure both sides agree on the baud rate
5. 🐛 [Open an issue](../../issues) with detailed error logs and configuration

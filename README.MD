...
| Content | Content |
|---------|---------|
| <p align="center"><img src="pics/rs-422.png" width="35%" align="center"></p> | **Notes:**<br>• Any serial communication standard will work. I chose RS-422.<br>• Any ESP32 / oled will work (if you add support for the display). I chose a T-Display-S3 here. |


Notes: 
- Any serial communication standard will work. <P>
  I chose RS-422.
- Any ESP32 / oled  will work (if you add support for the display). <P>
  I chose an  T-Display-S3 here.
